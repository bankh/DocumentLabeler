...
if __name__ == '__main__':
    # Emulate the argparse.Namespace object by creating a simple class that holds the hardcoded values.
    class Args:
        def __init__(self):
            self.config = "/mnt/data_drive/CSU_PhD/research/software/DocumentEngineering/DocumentLabeler_FinalDev/models/pick/config.json"
            self.resume = None
            self.device = "1,2,3,4,5,6"
            self.batch_size = 1
            self.distributed = "true"
            self.local_world_size = 6
            self.local_rank = 0
